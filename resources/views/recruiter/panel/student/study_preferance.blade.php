...
<div class="main-container container">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('agent.StudentStudyPreferanceRegstration', ['id' => $student->id]) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_area_of_study" name="intended_area_of_study">
                                <option value="">Select Area of Study</option>
                                @foreach ($StudyTypes as $studyType)
                                <option value="{{ $studyType->id }}" {{ old('intended_area_of_study', $student->intended_area_of_study) == $studyType->id ? 'selected' : '' }}>
                                    {{ $studyType->name }}
                                </option>
                                @endforeach
                            </select>
    ...
    @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_course_level" name="intended_course_level" required>
                                <option value="">Select Intended Course Level</option>
        ...
        @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="intended_institution" name="intended_institution" value="{{ old('intended_institution', $student->intended_institution) }}">
        ...
        @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_intake_quarter" name="intended_intake_quarter" >
                                <option value="">Select Intended Intake Quarter</option>
    ...
    @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_intake_year" name="intended_intake_year">
                                <option value="">Select Intended Intake Year</option>
                                @php
                                $currentYear = date('Y');
                                @endphp
                                @for ($i = $currentYear; $i <= $currentYear + 10; $i++) <option value="{{ $i }}" {{ old('intended_intake_year', $student->intended_intake_year) === $i ? 'selected' : '' }}>
                                    {{ $i }}
                                    </option>
                                    @endfor
                            </select>
    ...
    @enderror -->
        ...
        @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="funding_source" name="funding_source" value="{{ old('funding_source', $student->funding_source) }}">
        ...
        @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_destination_1" name="intended_destination_1" >
                                <option value="">Select Intended Destination 1</option>
    ...
    @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_destination_2" name="intended_destination_2" >
                                <option value="">Select Intended Destination 2</option>
                                @foreach($countries as $country)
    ...
    @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="intended_destination_3" name="intended_destination_3" >
                                <option value="">Select Intended Destination 3</option>
                                @foreach($countries as $country)
