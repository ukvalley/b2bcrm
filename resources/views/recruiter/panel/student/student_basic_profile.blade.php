    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form class="mt-3" method="POST" action="{{ route('agent.student_basic_registration') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('full_name') is-invalid @enderror" id="full_name" value="{{ old('full_name') }}" name="full_name" required>
                            @error('full_name')
        ...
        @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nationality') is-invalid @enderror" id="nationality" value="{{ old('nationality') }}" name="nationality" required>
                            @error('nationality')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
        ...
        @enderror -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" value="{{ old('phone_number') }}" name="phone_number" required>
                            @error('phone_number')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
