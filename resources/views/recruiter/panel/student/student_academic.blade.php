...
@endif
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="current_school" name="current_school" value="{{ old('current_school', $student->current_school) }}">
...
<div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="expected_graduation_year" name="expected_graduation_year" value="{{ old('expected_graduation_year', $student->expected_graduation_year) }}">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="academic_interests" name="academic_interests" rows="4">{{ old('academic_interests', $student->academic_interests) }}</textarea>
