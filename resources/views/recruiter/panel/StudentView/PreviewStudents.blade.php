    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> Email: </span> <br> <span class="font-weight-bold">{{$Student->email}}</span> </p>
            </div>

            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> Phone: </span> <br> <span class="font-weight-bold">{{$Student->phone_number}}</span> </p>
            </div>

            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> Nationality: </span> <br> <span class="font-weight-bold">{{$Student->nationality}}</span> </p>
            </div>

            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> Address: </span> <br> <span class="font-weight-bold">{{$Student->address}}</span> </p>
            </div>


            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> CIVS Student ID: </span> <br> <span class="font-weight-bold">{{$Student->id}}</span> </p>
            </div>

            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> Lead Status: </span> <br> <span class="font-weight-bold">{{$Student->lead_status}}</span> </p>
            </div>


            <div class="col-md-6 p-3">
                <p class=""><span class="text-muted"> Prospect Ratings: </span> <br> <span class="font-weight-bold">{{$Student->prospect_rating}}</span> </p>
            </div>
