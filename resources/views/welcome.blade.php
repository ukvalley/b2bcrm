...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" content="Cannada Immigration ,Visa and Services">
    <meta name="author" content="LiquidThemes">
    <meta name="description" content="Cannada Immigration ,Visa and Services.">
    <meta property="og:title" content="Cannada Immigration">
    <meta property="og:description" content="Cannada Immigration ,Visa and Services.">
    <meta property="og:type" content="website">
    <link rel="icon" href="civs/assets/images/1a.png">
    <link rel="stylesheet" href="civs/assets/vendors/liquid-icon/lqd-essentials/lqd-essentials.min.css">
    <link rel="stylesheet" href="civs/assets/css/theme.min.css">
    <link rel="stylesheet" href="civs/assets/css/utility.min.css">
    <link rel="stylesheet" href="civs/assets/css/demo/company/base.css">
    <link rel="stylesheet" href="civs/assets/css/demo/company/company.css">
    <link rel="preconnect" href="https://fonts.googleapis.com/">
    <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;700&amp;display=swap" rel="stylesheet">
    <title>Cannada Immigration</title>
  </head>
  <body class="lqd-preloader-style-fade lqd-sticky-footer-shadow-2 lqd-search-style-slide-top" data-localscroll-offset="72" data-mobile-nav-breakpoint="1199" data-mobile-nav-style="classic" data-mobile-nav-scheme="light" data-mobile-nav-trigger-alignment="right" data-mobile-header-scheme="gray" data-mobile-logo-alignment="default" data-overlay-onmobile="false">
    <div class="bg-white" id="wrap">
      ...
      <header id="site-header" class="main-header main-header-overlay" data-sticky-header="true">
        <section style="background-color: #e71f3f;" class="lqd-section lqd-hide-onstuck w-full flex flex-wrap items-center justify-between border-bottom border-white-10 transition-all px-2percent md:hidden">
            ...
            <div class="flex flex-row text-white">
              <div class="iconbox items-center mb-0">
                ...
                <h3 class="m-0 text-13 font-normal text-white iconbox-heading">
                  <a href="#" class="__cf_email__ text-white" >info@civs.online</a>
                </h3>
              </div>
              <div class="iconbox items-center mb-0 ml-20 pl-25 border-left border-white-10">
                ...
                <h3 class="iconbox-heading m-0 text-13 font-normal text-white">Singapore </h3>
              </div>
          ...
          <div class="w-50percent flex items-center justify-end py-10 link-white link-font-normal link-14">
            <a href="{{ url('recruiter/registration/step1') }}" class="btn btn-naked leading-16" rel="nofollow" data-localscroll="true">
              <span class="btn-txt" data-text="Consultation">Agent Registration</span>
            </a>
            <div class="pl-20 ml-20 border-left text-white-10">
              <a href="{{ url('institution/registration/step1') }}" class="btn btn-naked leading-16" rel="nofollow" data-localscroll="true">
                <span class="btn-txt" data-text="Contact us">Institution Registration</span>
              </a>
            </div>
        </section>
        <section class="lqd-section w-full flex flex-wrap items-center justify-between px-2percent module-header md:hidden" >
          <div class="w-15percent flex items-center justify-start">
            <a class="navbar-brand flex relative py-15" href="index-company.html" rel="home">
              <span class="navbar-brand-inner post-rel">
                <img class="logo-sticky" width="74" height="21" src="civs/assets/images/1a.png" alt="Hub Theme">
                <img class="logo-default" width="74" height="21" src="civs/assets/images/1a.png" alt="Hub Theme">
              </span>
            </a>
          </div>
          ...
          <div class="lqd-mobile-sec-nav w-full absolute z-10 bg-white text-black">
            <div class="mobile-navbar-collapse navbar-collapse collapse w-full" id="lqd-mobile-sec-nav" aria-expanded="false" role="navigation">
              <ul id="mobile-primary-nav" class="reset-ul lqd-mobile-main-nav main-nav nav" data-localscroll="true" data-localscroll-options="{&quot;itemsSelector&quot;:&quot;> li > a&quot;, &quot;trackWindowScroll&quot;: true}">
                <li class="is-active">
                  <a href="{{ url('recruiter/registration/step1') }}">Agent Registration <sup class="link-sup">01</sup>
                  </a>
                </li>
                <li>
                  <a href="{{ url('institution/registration/step1') }}">Institution Registration <sup class="link-sup">02</sup>
                  </a>
                </li>
      ...
      <main class="content bg-white bg-repeat" id="lqd-site-content" style="background-image: url(assets/images/demo/company/bg-lines.svg);">
        <div id="lqd-contents-wrap">
          <section class="lqd-section banner relative bg-center bg-cover transition-all" id="banner" style="background-image: url('civs/assets/images/newciv.jpg');">
            <div class="background-overlay transition-all  opacity-100"></div>
            <div class="container">
                  ...
                  <div class="ld-fancy-heading relative mask-text" data-custom-animations="true" data-ca-options="{&quot;animationTarget&quot;: &quot;.lqd-split-chars .lqd-chars .split-inner&quot;, &quot;duration&quot; : 1000 , &quot;delay&quot; : 40 , &quot;ease&quot;: &quot;power4.out&quot;, &quot;direction&quot;: &quot;random&quot;, &quot;initValues&quot;: {&quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;opacity&quot; : 1}}">
                    <h1 class="ld-fh-element mb-0/15em inline-block relative lqd-highlight-custom lqd-highlight-custom-1 lqd-split-chars text-88 text-white leading-0/9em" data-inview="true" data-transition-delay="true" data-delay-options="{&quot;elements&quot;: &quot;.lqd-highlight-inner&quot;, &quot;delayType&quot;: &quot;transition&quot;}" data-split-text="true" data-split-options="{&quot;type&quot;: &quot;chars, words&quot;}">
                      <mark class="lqd-highlight">
                        <span class="lqd-highlight-txt">Cannada</span>
                  ...
                  <div data-custom-animations="true" data-ca-options="{&quot;animationTarget&quot;: &quot;.animation-element&quot;, &quot;ease&quot;: &quot;power4.out&quot;}">
                    <div class="animation-element" data-custom-animations="true" data-ca-options="{&quot;animationTarget&quot;: &quot;.animation-element&quot;, &quot;startDelay&quot; : 800 , &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;y&quot;: &quot;50px&quot;, &quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;y&quot;: &quot;0px&quot;, &quot;opacity&quot; : 1}}">
                      <div class="ld-fancy-heading pr-10percent relative animation-element">
                        <p class="ld-fh-element inline-block relative text-22 font-normal leading-1/6em mb-1/5em text-white-70">Visa and Services  <br>Your journey to success starts here!</p>
                      </div>
                      @if (Route::has('login'))
                      ...
                      @else
                      <a href="{{ route('login') }}" class="btn btn-solid btn-md font-bold btn-icon-right btn-hover-reveal whitespace-nowrap text-16 rounded-4 text-secondary bg-primary py-15 px-55 hover:text-white hover:bg-secondary animation-element" data-localscroll="true">
                        <span class="btn-txt text-white" data-text="Get a quote">Login</span>
                      ...
                      <div class="inline-block w-auto relative animation-element">
                        <h6 class="ld-fh-element mt-0/5em ml-5em mb-0 inline-block relative">
                          <!-- <span class="text-13 text-white">                        <span class="btn-txt" data-text="Get a quote">Get a quote</span>
</span> -->
                          <br>
                          <!-- <span class="text-20 text-primary">----------</span> -->
                        </h6>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col col-12">
                <div class="ld-gmap-container h-340">
                  <div class="ld-gmap w-full h-full" data-plugin-map="true" data-plugin-options="{&quot;style&quot;: &quot;assassinsCreedIV&quot;, &quot;address&quot;: &quot;Manhattan&quot;, &quot;marker_style&quot;: &quot;html&quot;, &quot;markers&quot; : null , &quot;map&quot;: {&quot;zoom&quot; : 14 , &quot;mapTypeId&quot;: &quot;roadmap&quot;, &quot;zoomControl&quot;: true}}"></div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="col col-12 col-md-6">
                  <div class="relative flex flex-col justify-content transition-all border-1 border-black-10 rounded-4 pt-55 pb-35 px-60 module-inner">
                    ...
                    <div class="iconbox text-align-default mb-10 items-start">
                      ...
                      <h3 class="text-15 text-black-60 leading-1/5em">290 Maryam Springs 260, <br>Courbevoie, Paris </h3>
                    </div>
                    <div class="iconbox text-align-default mb-10 items-start">
                      <div class="iconbox-icon-wrap flex">
                        <span class="iconbox-icon-container text-gray-200 text-16 mr-15">
                      ...
                      <h3 class="text-15 text-black-60 leading-1/5em">
                        ...
                        <span class="text-black-60">
                          <a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="056d6069696a45696c74706c6128716d606860762b666a68">[email&#160;protected]</a>
                        </span>
                      </h3>
                    </div>
                    <div class="iconbox text-align-default mb-10 items-start">
                ...
                <div class="col col-12 col-md-6 col-lg-5 offset-lg-1">
                  <div class="lqd-contact-form lqd-contact-form-inputs-filled lqd-contact-form-inputs-round lqd-contact-form-button-block lqd-contact-form-button-round pr-12percent">
                    <div role="form" class="lqd-cf" lang="en-GB">
                      ...
                      <form action="https://hubhtml.liquid-themes.com/assets/php/mailer.php" method="post" class="lqd-cf-form" novalidate="novalidate" data-status="init">
                        <p>
                          <span class="lqd-form-control-wrap text">
                            <input type="text" name="name" value size="40" class="lqd-cf-form-control px-2em text-13 bg-gray-100 text-slate-300" aria-required="true" aria-invalid="false" placeholder="Your name">
                          </span>
                          <span class="lqd-form-control-wrap">
                            <input type="email" name="email" value size="40" class="lqd-cf-form-control px-2em text-13 bg-gray-100 text-slate-300" aria-required="true" aria-invalid="false" placeholder="Your Email Address">
                          </span>
                          <span class="lqd-form-control-wrap textarea">
                            <textarea name="message" cols="10" rows="4" class="lqd-cf-form-control px-2em text-13 bg-gray-100 text-slate-300" aria-required="true" aria-invalid="false" placeholder="Your message"></textarea>
                          </span>
                          <input type="submit" value="Send email" class="lqd-cf-form-control px-2em text-14 bg-primary text-white">
                        </p>
                      </form>
    ...
    <script data-cfasync="false" src="civs/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
    <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDRSq7_32muzQ4-hcsJwws4ZrtfqaFcsZg"></script>
    <script src="civs/assets/vendors/jquery.min.js"></script>
    <script src="civs/assets/vendors/bootstrap/js/bootstrap.min.js"></script>
    <script src="civs/assets/vendors/gsap/minified/gsap.min.js"></script>
    <script src="civs/assets/vendors/gsap/utils/SplitText.min.js"></script>
    <script src="civs/assets/vendors/gsap/minified/ScrollTrigger.min.js"></script>
    <script src="civs/assets/vendors/fastdom/fastdom.min.js"></script>
    <script src="civs/assets/vendors/flickity/flickity.pkgd.min.js"></script>
    <script src="civs/assets/vendors/flickity/flickity-fade.min.js"></script>
    <script src="civs/assets/vendors/lity/lity.min.js"></script>
    <script src="civs/assets/vendors/fresco/js/fresco.js"></script>
    <script src="civs/assets/vendors/fontfaceobserver.js"></script>
    <script src="civs/assets/js/liquid-gdpr.min.js"></script>
    <script src="civs/assets/js/theme.min.js"></script>
    <script src="civs/assets/js/liquid-ajax-contact-form.min.js"></script>
  ...
  <!-- Mirrored from hubhtml.liquid-themes.com/index-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Dec 2023 11:23:35 GMT -->
</html>