...
<!-- Begin page -->
 <!-- Begin page -->
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('admission_requirements') is-invalid @enderror"  value="{{$course->admission_requirements}}"  id="admission_requirements" name="admission_requirements" required>
    ...
    <div class="mb-3">
        ...
        <select class="form-select @error('international_students') is-invalid @enderror" id="international_students"  name="international_students" required>
            <option value="yes" @if($course->international_students == "yes") selected @endif>Yes</option>
            <option value="no" @if($course->international_students == "no") selected @endif >No</option>
        </select>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('english_requirements') is-invalid @enderror" value="{{$course->english_requirements}}" id="english_requirements" name="english_requirements" required>
    ...
    <div class="mb-3">
        ...
        <input type="Date" class="form-control @error('course_dates') is-invalid @enderror" value="{{$course->course_dates}}" id="course_dates" name="course_dates" required>
        @error('course_dates')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('institution_overview') is-invalid @enderror" value="{{$course->institution_overview}}" id="institution_overview" name="institution_overview" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('institution_type') is-invalid @enderror" value="{{$course->institution_type}}" id="institution_type" name="institution_type" required>
