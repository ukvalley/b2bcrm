...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('documents')->insert([
            ...
            ['name' => 'English Language: English Proficiency Transcript/Results', 'type' => 'B2 Language'],
            ['name' => 'Experience: CVDB', 'type' => 'B2'],
            ['name' => 'Financial: Additional Funds and Assets', 'type' => 'C1'],
            ['name' => 'Financial: Affidavit of Financial Support', 'type' => 'C1'],
            ['name' => 'Financial: Bank Balance Confirmations and Statements', 'type' => 'C1'],
            ['name' => 'Financial: Health Insurance Policy', 'type' => 'C1'],
            ['name' => 'Financial: Loan Grant and Disbursement Letters', 'type' => 'C1'],
            ['name' => 'Financial: Proof of Income', 'type' => 'C1'],
            ['name' => 'Financial: Relationship Evidence of the Sponsors', 'type' => 'C1'],
            ['name' => 'Financial: Sponsor Declaration', 'type' => 'C1'],
            ['name' => 'Form 956a Appointment or withdrawal of an authorised recipient', 'type' => 'C1'],
            ['name' => 'Identity: Biometrics Appointment Booking', 'type' => 'C2'],
            ['name' => 'Identity: Birth Certificate', 'type' => 'C2'],
            ['name' => 'Identity: National Identity Card (NIC) / Aadhar Card', 'type' => 'C2'],
            ['name' => 'Identity: Passport Certified Lawyer for Visa Application', 'type' => 'C2'],
            ['name' => 'Identity: Photograph', 'type' => 'C2'],
            ['name' => 'Identity: Sponsors Passport and/or Birth Certificate', 'type' => 'C2'],
            ['name' => 'Intention: Statement of Purpose', 'type' => 'C2'],
            ['name' => 'Medical: Medical Clearance', 'type' => 'C2'],
            ['name' => 'Experience: Letter of Employment', 'type' => 'C2'],
            ['name' => 'Experience: Professional Accreditation', 'type' => 'C2'],
            ['name' => 'Financial: Visa Application Fee', 'type' => 'D1'],
            ['name' => 'Identity: CAAW Letter (Confirmation of Appropriate Accommodation and Welfare) for under 18 students', 'type' => 'D1'],
            ['name' => 'Identity: CV of Dependents', 'type' => 'D1'],
            ['name' => 'Identity: Consent Letter (required only for under 18 students)', 'type' => 'D1'],
            ['name' => 'Identity: Marriage Certificate', 'type' => 'D1'],
            ['name' => 'Identity: Passport of Dependents', 'type' => 'D1'],
            ['name' => 'Identity: Previous Visa Grants and Refusals', 'type' => 'D1'],
            ['name' => 'Identity: Sponsor Affidavit and Tax Return (if applicable)', 'type' => 'D1'],
            ['name' => 'Intention: Dependent Statement of Purpose', 'type' => 'D1'],
            ['name' => 'Visa: Application', 'type' => 'D1'],
            ['name' => 'Visa: Grant Notification', 'type' => 'D1'],
            ['name' => 'Visa: Refusal Notification', 'type' => 'D1']
        ]);
